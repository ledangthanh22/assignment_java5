    ...
    <div class="col-10 offset-1">
        <div class="border " style="padding: 20px 20px 50px 20px; background-color: #fff;margin-top: 20px">
            <form:form action="/nhan-vien/update" method="post" modelAttribute="staff">
                <h4 class="text-center text-danger mb-3">Update Staff</h4>
                <div class="modal-body">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-6">
                            ...
                            <form:input path="birthday" required="true" cssClass="form-control" type="date"/>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-check form-check-inline">
                                <form:radiobutton path="status" cssClass="form-check-input" value="0" label="doing"/>
                            </div>
                            <div class="form-check form-check-inline">
                        ...
                        <div class="col-6">
                            ...
                            <form:select path="cuaHang" cssClass="form-select">
                                <c:forEach items="${listShops}" var="ch">
                                    <option ${staff.cuaHang.id == ch.id?"selected":""} value="${ch.id}">${ch.name}</option>
                                </c:forEach>
                            </form:select>
                        </div>
                        <div class="col-6">
                            ...
                            <form:select path="chucVu" cssClass="form-select">
                                <c:forEach items="${listPositions}" var="cv">
                                    <option ${staff.cuaHang.id == cv.id?"selected":""} value="${cv.id}">${cv.name}</option>
                                </c:forEach>
                            </form:select>
                        </div>
                    </div>
                    <div class="form-group  mb-3 float-end">
                        <div class="col-5">
                            <button onclick="return confirm('Are you sure!')" class="btn btn-success">Upadte</button>
                        </div>
                    </div>
                </div>
            </form:form>
